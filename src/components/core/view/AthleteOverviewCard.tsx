            ...
            <div className="text-sm">
                <ul className="grid gap-3 p-6">
                    ...
                    <li className="flex items-center">
                        ...
                        <span className="text-muted-foreground">
                            {athlete?.athleteAge || "N/A"}
                        </span>
                    </li>
                    <li className="flex items-center">
                        <span className="w-1/2">Gender</span>
                        <span className="text-muted-foreground">
                            {athlete?.athleteGender?.name || "N/A"}
                        </span>
                    </li>
                </ul>
            </div>
