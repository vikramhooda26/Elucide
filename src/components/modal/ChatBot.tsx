...
const ChatBot = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      {!isOpen && (
        <motion.div
          className="flex h-16 w-16 cursor-pointer items-center justify-center rounded-full border border-primary bg-primary-foreground shadow-lg"
      ...
      {isOpen && (
        ...
        >
          <motion.div
            className="relative h-[80vh] w-[80vh] rounded-lg border-2 border-primary bg-primary-foreground p-6 shadow-xl"
