        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="flex flex-col items-center animate-fadeIn">
            ...
            <p className="text-center">
              Understand brand objectives & leverage our advanced search filters find the best match for your brand.
            </p>
          </div>
          <div className="flex flex-col items-center animate-fadeIn delay-1s">
            <h6 className="font-bold mb-4 text-2xl">Analyze</h6>
            <p className="text-center">
              Use industry insights & AI-enhanced match-making capability to analyze the ideal fit based on brand objectives.
            </p>
          </div>
          <div className="flex flex-col items-center animate-fadeIn delay-2s">
            <h6 className="font-bold mb-4 text-2xl">Engage</h6>
            <p className="text-center">
              Facilitate & execute partnerships with the identified stakeholders to create mutually beneficial associations.
            </p>
          </div>
        </div>
        <div className="text-center relative z-10 flex flex-col items-center justify-center">
          ...
          <div className="w-full md:w-1/3 text-center my-5">
            ...
            <div className="flex space-x-4 items-center justify-center">
              ...
              <a href="https://twitter.com" className="text-blue-500 animate-pulse">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://instagram.com/@elucidesports" className="text-blue-500 animate-pulse">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://linkedin.com/elucide_sports" className="text-blue-500 animate-wiggle">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='flex flex-col items-start gap-2 mb-5'>
            <div className='flex items-center gap-2'>
              <a href="tel:+1234567890" className="text-blue-500 animate-pulse">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              </a> <span>+91-7011353855</span>
            </div>
            <div className='flex items-center gap-2'>
              <a href="mailto:info@sponsor-sync.com" className="text-blue-500 animate-pulse">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              </a> <span>info@elucidesports.in</span>
            </div>
          </div>

          <p className="text-sm animate-pulse">© {new Date().getFullYear()} Advanced Tech Co. All rights reserved.</p>
        </div>
      </div >
