      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="animate-fadeIn delay-1s flex flex-col items-center">
            ...
            <p className="text-center">
              Use industry insights & AI-enhanced match-making capability to analyze the ideal fit based on brand
              objectives.
            </p>
          </div>
          <div className="animate-fadeIn delay-2s flex flex-col items-center">
            ...
            <p className="text-center">
              Facilitate & execute partnerships with the identified stakeholders to create mutually beneficial
              associations.
            </p>
          </div>
        </div>
        <div className="relative z-10 flex flex-col items-center justify-center text-center">
          <div className="my-5 w-full text-center md:w-1/3">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <a href="https://instagram.com/@elucidesports" target="_blank" className="animate-pulse text-blue-500">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://linkedin.com/elucide_sports" target="_blank" className="animate-wiggle text-blue-500">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
