    ...
    <div className="relative flex w-full justify-center border-t border-input px-8 py-24 md:min-h-dvh md:py-40">
      ...
      <div className="w-[96%]">
        ...
        <p className="mb-20 mt-12 max-w-xl text-xl">
          Our proprietary matchmaking platform boasts various features that provide unique insights, making it an
          unparalleled resource in the Indian sports landscape.
        </p>
