  ...
  return (
    ...
    >
      ...
      <p className="my-6 text-start text-white sm:max-w-md sm:text-center md:max-w-2xl md:text-2xl">
        An end-to-end sports sponsorship service centered around an AI-enhanced matchmaking platform, designed to
        discover and engage with the ideal sports teams, leagues, athletes, and events.
      </p>
      <div className="flex w-full items-center justify-center gap-5 max-sm:flex-col">
        <GradientButton
          onClick={() => (isAuthenticated ? navigate(NAVIGATION_ROUTES.DASHBOARD) : navigate(NAVIGATION_ROUTES.LOGIN))}
        >
