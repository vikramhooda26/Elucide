...
function AthleteRecentList() {
  ...
  return (
    <>
      <RecentList title={'Added Athletes'} list={athleteList} operation={'created by'} nameKey={'name'} dateKey={'createdDate'} operationKey={'createdBy'} />
      <RecentList title={'Modified Athletes'} list={athleteList} operation={'modified by'} nameKey={'name'} dateKey={'modifiedDate'} operationKey={'modifiedBy'} />
    </>
  )
}
