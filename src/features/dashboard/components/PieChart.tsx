  ...
  return (
    <Card className="flex flex-col border-none">
      ...
      <CardContent className="flex-1 pb-0">
        <ChartContainer config={chart?.chartConfig} className="mx-auto aspect-square max-h-[250px] lg:max-h-[350px]">
          <PieChart>
            ...
            <Pie data={chart?.chartData} dataKey="total">
              <LabelList
                ...
                stroke="none"
                fontSize={12}
                formatter={(value: keyof typeof chart.chartConfig) => chart?.chartConfig?.[value]?.label}
              />
            </Pie>
          </PieChart>
        </ChartContainer>
